        ...
        describe(`in ${suite.label} state`, () => {
            ...
            it('should have a box indicator representing state', () => {
                ...
                const indicator = suite.checked ? [
                    ...
                    [bx,bx,bx,bx,bx,bx,bx,im,im,ch,ch,ch,ch,ch,ch,im,im,ch,ch,ch,ch,ch,ch,im,im,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx],
                    [bx,bx,bx,bx,bx,bx,bx,bx,im,im,ch,ch,ch,ch,im,ch,im,im,ch,ch,ch,ch,im,im,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx],
                    [bx,bx,bx,bx,bx,bx,bx,bx,bx,im,im,ch,ch,im,ch,ch,ch,im,im,ch,ch,im,im,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx],
                    ...
                    [bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,im,ch,ch,ch,ch,ch,ch,ch,im,im,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx],
                    [bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,im,ch,ch,ch,ch,ch,im,im,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx],
                    [bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,im,ch,ch,ch,im,im,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx],
                    [bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,im,ch,im,im,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx],
                    [bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,im,im,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx],
                    [bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx],
                    [bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx],
                    [bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx],
                    [bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx,bx],
